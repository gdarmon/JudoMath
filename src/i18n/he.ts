...
export const REWARD = {
  ...
  continueGame: 'המשך למשחק',
  continueGameAria: 'חזור למשחק',
  continueWatching: 'להמשיך לצפות',
  continueWatchingAria: 'להמשיך לצפות בסרטון',
  keepWatchingPrompt: 'רוצה להמשיך לצפות?',
  extendedWatching: 'צופה בכיף',
